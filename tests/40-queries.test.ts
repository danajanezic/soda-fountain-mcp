...
describe("Level 1: Basic queries", () => {
  ...
  it("Q1: search datasets for 'fire'", async () => {
    const result = parseToolResult(await handleSearchDatasets(client, { query: "fire" }));
  ...
  it("Q2: search datasets by category 'Business'", async () => {
    const result = parseToolResult(await handleSearchDatasets(client, { category: "Business" }));
    expect(result.results.length).toBeGreaterThan(0);
  }, 15_000);

  // Q3: Get schema for Active Businesses
  it("Q3: get schema for active businesses (tckn-sxa6)", async () => {
    const result = parseToolResult(await handleGetDatasetSchema(client, { datasetId: "tckn-sxa6" }));
  ...
  it("Q4: select 3 rows from active businesses", async () => {
    const mcp = parseToolResult(await handleQueryDataset(client, {
      datasetId: "tckn-sxa6", select: "business_name, city", limit: 3, offset: 0,
    }));
  ...
  it("Q5: select 5 rows from state salaries (4cmg-5yp4)", async () => {
    const mcp = parseToolResult(await handleQueryDataset(client, {
      datasetId: "4cmg-5yp4", select: "agency_title, classification, annual_salary", limit: 5, offset: 0,
    }));
  ...
  it("Q6: get schema for fire occurrence (fbwv-q84y)", async () => {
    const result = parseToolResult(await handleGetDatasetSchema(client, { datasetId: "fbwv-q84y" }));
  ...
  it("Q7: pagination - page 2 of active businesses", async () => {
    const mcp = parseToolResult(await handleQueryDataset(client, {
      datasetId: "tckn-sxa6", select: "business_name", limit: 5, offset: 5,
    }));
  ...
  it("Q8: oldest businesses by registry_date ASC", async () => {
    const mcp = parseToolResult(await handleQueryDataset(client, {
      datasetId: "tckn-sxa6", select: "business_name, registry_date",
  ...
  it("Q9: full-text search for 'coffee' in businesses", async () => {
    const mcp = parseToolResult(await handleQueryDataset(client, {
      datasetId: "tckn-sxa6", search: "coffee", limit: 5, offset: 0,
    }));
  ...
  it("Q10: search datasets 'salary' in Revenue & Expense", async () => {
    const result = parseToolResult(await handleSearchDatasets(client, {
...
describe("Level 2: Intermediate queries", () => {
  ...
  it("Q11: businesses in PORTLAND", async () => {
    const mcp = parseToolResult(await handleQueryDataset(client, {
      datasetId: "tckn-sxa6", select: "business_name, city",
  ...
  it("Q12: salaries above $150,000", async () => {
    const mcp = parseToolResult(await handleQueryDataset(client, {
      datasetId: "4cmg-5yp4", select: "agency_title, classification, annual_salary",
  ...
  it("Q13: businesses in SALEM that are nonprofits", async () => {
    const mcp = parseToolResult(await handleQueryDataset(client, {
      datasetId: "tckn-sxa6", select: "business_name, city, entity_type",
  ...
  it("Q17: businesses NOT containing 'LLC' in name", async () => {
    const mcp = parseToolResult(await handleQueryDataset(client, {
      datasetId: "tckn-sxa6", select: "business_name, entity_type",
  ...
  it("Q18: fires in 2020", async () => {
    const mcp = parseToolResult(await handleQueryDataset(client, {
      datasetId: "fbwv-q84y", select: "firename, esttotalacres, county",
  ...
  it("Q19: fires caused by lightning OR smoking", async () => {
    const mcp = parseToolResult(await handleQueryDataset(client, {
      datasetId: "fbwv-q84y", select: "firename, generalcause, county",
  ...
  it("Q20: consumer complaints with closing description", async () => {
    const mcp = parseToolResult(await handleQueryDataset(client, {
      datasetId: "2ix7-8hwk", select: "respondent, complaint_description, closing_description",
...
describe("Level 3: Aggregation queries", () => {
  ...
  it("Q21: count businesses by city, top 5", async () => {
    const mcp = parseToolResult(await handleQueryDataset(client, {
      datasetId: "tckn-sxa6", select: "city, count(*) as total",
  ...
  it("Q22: count businesses by entity type", async () => {
    const mcp = parseToolResult(await handleQueryDataset(client, {
      datasetId: "tckn-sxa6", select: "entity_type, count(*) as cnt",
  ...
  it("Q23: average salary by agency, top 5", async () => {
    const mcp = parseToolResult(await handleQueryDataset(client, {
      datasetId: "4cmg-5yp4", select: "agency_title, avg(annual_salary) as avg_salary",
  ...
  it("Q24: total fire acres by county, top 5", async () => {
    const mcp = parseToolResult(await handleQueryDataset(client, {
      datasetId: "fbwv-q84y", select: "county, sum(esttotalacres) as total_acres",
  ...
  it("Q25: fire count by year", async () => {
    const mcp = parseToolResult(await handleQueryDataset(client, {
      datasetId: "fbwv-q84y", select: "fireyear, count(*) as fire_count",
  ...
  it("Q27: fire count by general cause", async () => {
    const mcp = parseToolResult(await handleQueryDataset(client, {
      datasetId: "fbwv-q84y", select: "generalcause, count(*) as cnt",
  ...
  it("Q29: average fire size by year, recent first", async () => {
    const mcp = parseToolResult(await handleQueryDataset(client, {
      datasetId: "fbwv-q84y", select: "fireyear, avg(esttotalacres) as avg_acres",
      group: "fireyear", order: "fireyear DESC", limit: 10, offset: 0,
    }));
    const direct = await directQuery("fbwv-q84y", {
...
describe("Level 4: Advanced queries", () => {
  ...
  it("Q40: full workflow - search, schema, then complex query", async () => {
    ...
    const searchResult = parseToolResult(await handleSearchDatasets(client, { query: "salary state" }));
    ...
    // Step 2: Get schema
    const schema = parseToolResult(await handleGetDatasetSchema(client, { datasetId: salaryDataset.id }));
    expect(schema.columns.length).toBeGreaterThan(0);

    // Step 3: Complex query using schema knowledge
    const mcp = parseToolResult(await handleQueryDataset(client, {
      datasetId: salaryDataset.id,
